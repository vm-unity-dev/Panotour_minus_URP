...
namespace Mbryonic.Panotour
{
    ...
    public class PanotourPlayer : MonoBehaviour
    {
        ...
        public LocationEvent OnVideoFirstFrame; // called when the video player is spooled and ready on frame 1
        ...
        public void UpdateLocation()
        {
            ...
            {  // not sure about performance on this??
        ...
        protected void CreateLocation(int locationIndex)
        {
            ...
            if (activeLocation.patches != null)
            {
                ...
                foreach (Patch patch in activeLocation.patches)
                {
                    ...
                    // ---- JQ  -- TODO - attempt to generate a still image patch to render on top of the video texture in order to mask and feather the edges of the video patch 
